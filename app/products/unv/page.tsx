    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Browse our selection of UNV surveillance and security products for all your needs.
        </p>
      </div>
      ...
      <div className="mt-16 bg-gradient-to-r from-blue-500 to-blue-700 rounded-xl p-8 text-center text-white">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Questions about UNV products?</h2>
        <p className="text-lg mb-6 max-w-2xl mx-auto">Our team can provide detailed information and help you choose the right UNV solutions.</p>
